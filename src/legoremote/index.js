// https://github.com/bricklife/scratch-lego-bluetooth-extensions/tree/master/scratch-vm/src/extensions/scratch3_legoremote
(async function (Scratch, require) {
    ...
    class Scratch3LegoRemoteBlocks {
        ...
        constructor() {
            this._peripheral = new Hub(Scratch.vm.runtime, Scratch3LegoRemoteBlocks.EXTENSION_ID, 0x42);
        }
    ...
    Scratch.extensions.register(new Scratch3LegoRemoteBlocks());
    ...
    Scratch.extensions.translations({
        ...
        'zh-cn': {
            'legoremote.whenButton': '当按下 [PORT] 组 [BUTTON] 按键',
            'legoremote.isButton': '按下 [PORT] 组 [BUTTON] 按键？',
            'legoremote.getButtonA': 'A 组按键',
            'legoremote.getButtonB': 'B 组按键',
            'legoremote.setHubLEDColor': '将 LED 颜色设为 [COLOR]',
            'legoremote.button.plus': '✚',
            'legoremote.button.minus': '▬',
            'legoremote.button.stop': '红色',
            'legoremote.button.any': '任意',
        },
        'zh-tw': {
            'legoremote.whenButton': '當按下 [PORT] 組 [BUTTON] 按鍵',
            'legoremote.isButton': '按下 [PORT] 組 [BUTTON] 按鍵？',
            'legoremote.getButtonA': 'A 組按鍵',
            'legoremote.getButtonB': 'B 組按鍵',
            'legoremote.setHubLEDColor': '將 LED 顏色設為 [COLOR]',
            'legoremote.button.plus': '✚',
            'legoremote.button.minus': '▬',
            'legoremote.button.stop': '紅色',
            'legoremote.button.any': '任意',
        },
    });
})(Scratch, require);
