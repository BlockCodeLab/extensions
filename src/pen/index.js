(function () {
    ...
    const EVENT_TARGET_MOVED = 'TARGET_MOVED';
    const PEN_LAYER = 'pen';
    ...
    class Scratch3PenBlocks {
        constructor () {
            ...
            this.runtime.on('RUNTIME_DISPOSED', this.clear.bind(this));
        }
        ...
        _getPenLayerID () {
            if (this._penSkinId < 0 && this.runtime.renderer) {
                ...
                this._penDrawableId = this.runtime.renderer.createDrawable(PEN_LAYER);
        ...
        _onTargetCreated (newTarget, sourceTarget) {
            if (sourceTarget) {
                ...
                if (penState) {
                    ...
                    if (penState.penDown) {
                        newTarget.addListener(EVENT_TARGET_MOVED, this._onTargetMoved);
                    }
                }
            }
        }
        ...
        penDown (args, util) {
            ...
            if (!penState.penDown) {
                ...
                target.addListener(EVENT_TARGET_MOVED, this._onTargetMoved);
            }
        ...
        penUp (args, util) {
            ...
            if (penState.penDown) {
                ...
                target.removeListener(EVENT_TARGET_MOVED, this._onTargetMoved);
            }
        }
