(async function () {
    ...
    class Scratch3VideoSensingBlocks {
        constructor () {
            ...
            this.runtime.on('videoSensing.videoOff', () => {
                this.videoToggle({
                    VIDEO_STATE: VideoState.OFF
                });
            });
            this.runtime.on('videoSensing.videoOn', () => {
                this.videoToggle({
                    VIDEO_STATE: VideoState.ON
                });
            });

            this.runtime.emit('videoSensing.installed', this.globalVideoState);
        }
        ...
        _loop () {
            ...
            if (offset > Scratch3VideoSensingBlocks.INTERVAL) {
                ...
                if (frame) {
                    ...
                    this.runtime.emit('videoSensing.frame', {
                        data: Base64Util.arrayBufferToBase64(frame.data),
                        width: frame.width,
                        height: frame.height
                    });
                }
        ...
        videoToggle (args) {
            ...
            this.runtime.emit('videoSensing.state', state);
        }
